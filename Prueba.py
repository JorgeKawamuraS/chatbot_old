...
def check_all_messages(message):
    ...
    response('Hoy deberías cocinar '+ ['Chaufa', 'Ají de Gallina', 'Papa rellena','Tallarines Rojos','Panqueques','Ensalada Rusa','Sopa a la minuta','MIlanesa','Tallarines verde'][
        random.randrange(9)], ['recomiendas', 'cocinar', 'debería', 'hacer','preparar'], single_response=True)
